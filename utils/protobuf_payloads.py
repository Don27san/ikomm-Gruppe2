...
server_announce.serverId=config['server_id']
...
connect_client.user.serverId = config['server_id'] #Static value, must be replaced if necessary
...
typing_event.user.serverId = config['server_id'] #Static value, must be replaced if necessary
...
live_location.user.serverId = config['server_id'] #Static value, must be replaced if necessary
