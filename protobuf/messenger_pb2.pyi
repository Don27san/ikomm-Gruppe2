...
class LiveLocation(_message.Message):
    __slots__ = ("author", "user", "group", "userOfGroup", "timestamp", "expiry_at", "location")
    ...
    def __init__(self, author: _Optional[_Union[User, _Mapping]] = ..., user: _Optional[_Union[User, _Mapping]] = ..., group: _Optional[_Union[Group, _Mapping]] = ..., userOfGroup: _Optional[_Union[UserOfGroup, _Mapping]] = ..., timestamp: _Optional[float] = ..., expiry_at: _Optional[float] = ..., location: _Optional[_Union[LiveLocation.Location, _Mapping]] = ...) -> None: ...
